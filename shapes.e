...
--/*
--= Library: shapes.e
--Description: a collection of shape "class"es using the OE4OOP approach
------
--[[[Version: 4.0.5.0
...
--
--* area - this holds the routine-id for a function which varies between child
--  shapes
--
...
-- <eucode>include shapes.e</eucode>
...
constant carea = routine_id("c_area")
--------------------------------------------------------------------------------
export function Circle(atom radius) --> [circle] unique id
    shapes = append(shapes, {carea, radius})
    shp += 1
...
constant rarea = routine_id("r_area")
--------------------------------------------------------------------------------
export function Rectangle(atom len, atom breadth) --> [rectangle] unique id
    shapes = append(shapes, {rarea, len, breadth})
    shp += 1
    return shp -- a serial number; index to storage
end function
--------------------------------------------------------------------------------
...
constant tarea = routine_id("t_area")
--------------------------------------------------------------------------------
export function Triangle(atom a, atom b, atom c) --> [triangle] unique id
    shapes = append(shapes, {tarea, a, b, c})
    shp += 1
    return shp -- a serial number; index to storage
end function
--------------------------------------------------------------------------------
